...
We can build something like that now. Write a 
function min that takes two arguments 
...
string by writing "string"[N]. The returned 
value will be a string containing only 
one character (for example, "b"). The first 
character has position 0, which causes the 
...
// function countChar(word, chUpper){
//     let counter = 0;
//     Array.from(word).forEach(letter => {
//         if(letter===chUpper) counter++;
//     });
//     return counter;
// }
